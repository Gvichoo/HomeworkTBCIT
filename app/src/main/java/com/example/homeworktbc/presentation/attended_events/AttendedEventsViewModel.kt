package com.example.homeworktbc.presentation.attended_events
...
import com.example.homeworktbc.presentation.attended_events.effect.AttendedEventsEffect
import com.example.homeworktbc.presentation.attended_events.event.AttendedEventsEvent
import com.example.homeworktbc.presentation.attended_events.state.AttendedEventsState
...
) : BaseViewModel<AttendedEventsState, AttendedEventsEvent, AttendedEventsEffect>(
    AttendedEventsState()
) {
